...
import { MprisCorner } from './centermodules/mpris/index.js';
import Cava from './centermodules/cava/index.js';
...
export default () => Box({
    ...
    setup: (self) => self
        .on('key-press-event', (widget, event) => { // Handle keybinds
            ...
            else if (checkKeybind(event, userOptions.keybinds.sidebar.pin))
