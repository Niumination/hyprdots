...
function sendMessage(textView, filesContainer) {
    ...
    CodyAIService.send(filesContainer);
...
const SettingsContainer = () => Box({ vertical: true });

const Message = (msg, parent) => Box({ vertical: true });
            ...
            Scrollable({
                ...
                child: Box({ vertical: true })
                    .hook(CodyAIService, (box, idx) => {
                        ...
                        if (msg) box.add(Message(msg, box.get_parent()));
                    }, 'newMsg')
                    .hook(CodyAIService, (box) => box.children = [], 'clear'),
            }),
            Box({
                        ...
                        children: [
                            ...
                            Button({
                                ...
                                on_clicked: (btn) => {
                                    ...
                                    if (parent) {
                                        const textView = parent.get_child();
                                        if (textView) {
        ...
        headerChild: Box({
            ...
            children: [
                Button({
                    ...
                    child: Box({
                        children: [Label('Clear '), Icon(icons.trash.empty)],
                    }),
                }),
                Button({
