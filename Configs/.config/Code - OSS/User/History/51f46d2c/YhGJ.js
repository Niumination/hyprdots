...
const scripts = [
    ...
    },
    {
        ...
        command: `sudo pacman -Scc --noconfirm && sudo pacman -Sc --noconfirm && yay -Yc --noconfirm && yay -Sc --noconfirm && yay -Scc --noconfirm`,
        enabled: isArchDistro,
    },
    {
        icon: 'arch-symbolic',
        name: 'Repair Whole Package',
        command: `sudo pacman -Qknq | cut -d' ' -f 1 | sudo pacman -S -`,
        enabled: isArchDistro,
    },
    //{
    //    icon: 'hyprland-symbolic',
    //    name: 'Ganti Tema AGS - Kotontrin',
    //    command: 'mv ~/.config/ags ~/.config/ags.bak && mv ~/RUANG-VI/My-Ags-Conf/ags-koton-berhasil ~/.config/ags && hyprctl reload && ags -q && ags &',
    //    enabled: isArchDistro,
    //},
    {
        icon: 'arch-symbolic',
    ...
    {
        icon: 'arch-symbolic',
        name: 'Edit This Quick Scripts',
        command: `nvim ~/.config/ags2/modules/sideleft/tools/quickscripts.js`,
        enabled: isArchDistro,
    },
];
