...
export class waifuMessage extends Service {
  static {
...
class waifuService extends Service {
  ...
  */
  ...
  send(msg) {
    ...
    this.messages.push(new waifuMessage("user", msg));
    ...
    const aiResponse = new waifuMessage("assistant", "thinking...", true);
