...
let configOptions = {
    ...
    'cheatsheet': {
        'keybinds': {
            'configPath': "$HOME/.config/hypr/keybindings.conf" // Path to hyprland keybind config file. Leave empty for default (~/.config/hypr/hyprland/keybinds.conf)
        }
    },
    'gaming': {
        'crosshair': {
