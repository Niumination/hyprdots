...
const hasWebKit = GLib.find_program_in_path('webkit2gtk-4.1') !== null;

// export const AIService = {
//     initialize: () => {
//         if (!hasWebKit) {
//             console.log('webkit2gtk-4.1 is not installed. CodyAI features will be limited.');
//             return;
//         }
...
class CodyAIService extends Service {
  ...
  constructor() {
    ...
    if (!TOKEN) {
      ...
      throw new Error("CodyAI: API Key is not set!");
    }
  }
  ...
  set model(CodyAIMessage) {
    if(!this.getModels(// export const AIService = {
//     initialize: () => {
//         if (!hasWebKit) {
//             console.log('webkit2gtk-4.1 is not installed. CodyAI features will be limited.');
//             return;
