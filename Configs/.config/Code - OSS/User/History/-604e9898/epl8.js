  ...
  return Widget.Box({
      ...
      children: [
          ...
          Widget.CircularProgress({
              ...
              widthRequest: 16,
              heightRequest: 16,
              background_color: Cairo.Color.TRANSPARENT,
              background_line_width: 0,
              background_line_cap: Cairo.LineCap.BUTT,
              background_line_dash: [0, 0],
              background_line_dash_offset: 0,
              background_line_color: Cairo.Color.TRANSPARENT,
              line_width: 2,
              line_cap: Cairo.LineCap.BUTT,
              line_dash: [0, 0],
              line_dash_offset: 0,
              line_color: Cairo.Color.WHITE,
              line_color_start: Cairo.Color.WHITE,
              line_color_end: Cairo.Color.WHITE,
              line_color_stop: 1,
              line_color_stop_opacity: 1,
              line_color_stop_opacity_end: 1,
          });
          //Widget.LevelBar({
          //    widthRequest: 50,
          //    vpack: "center",
