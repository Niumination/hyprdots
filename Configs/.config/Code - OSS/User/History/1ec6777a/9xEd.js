...
import { SubpixelLayout } from "types/@girs/gdk-3.0/gdk-3.0.cjs";
import { SubprocessLauncher } from "types/@girs/gio-2.0/gio-2.0.cjs";
...
export default async () => {
  ...
  const addKeyBinds = (mods) => {
    ...
    window.keybind(mods, "Page_Down", () => LauncherStack.Children.next());
    for (let i = 0; i < 10; i++) {
